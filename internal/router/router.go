...
func InitRouter(
	...
	Register(e)
	e.POST("/subscription", subscriberService.CreateSomething)
	e.GET("/subscription", subscriberService.GetSomething)
	e.PATCH("/subscription", subscriberService.UpdateSomething)
	e.DELETE("/subscription", subscriberService.DeleteSomething)
